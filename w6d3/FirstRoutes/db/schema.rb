...
ActiveRecord::Schema.define(version: 2021_02_26_002637) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["author_id", "artwork_id", "body"], name: "index_comments_on_author_id_and_artwork_id_and_body", unique: true
